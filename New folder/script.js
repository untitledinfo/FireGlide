...
/* =========================================================
   ...
   remote branch/host being reachable. Only files that actually ship in
   /assets are listed here; anything without real art (game icons, event
   art, the Discord promo shot) is left unset on purpose so the page never
   fires a request that is guaranteed to 404 — it goes straight to the
   built-in hexagon/icon mark instead, on every device, instantly. */
...
const GAMES = [
  { name:"Minecraft", glyph:"M", icon:"fa-cube",           accent:"#6ee06e", activity:"Most played · events weekly", level:94 },
  { name:"Roblox", glyph:"R",    icon:"fa-shapes",         accent:"#ff5d5d", activity:"Obbies and custom rounds",    level:81 },
  { name:"Fortnite", glyph:"F",  icon:"fa-parachute-box",  accent:"#9b6bff", activity:"Duos night every Friday",     level:68 },
  { name:"Valorant", glyph:"V",  icon:"fa-bullseye",       accent:"#ff4d6d", activity:"Ranked stacks and scrims",    level:73 },
  { name:"GTA", glyph:"G",       icon:"fa-car-side",       accent:"#ffb03a", activity:"Roleplay and heist runs",     level:57 },
  { name:"Call of Duty", glyph:"C", icon:"fa-crosshairs",  accent:"#00d4ff", activity:"Late-night lobbies",          level:64 }
];
